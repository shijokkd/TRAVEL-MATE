    ...
    <div
      ...
      <div className="w-full h-full flex justify-center lg:flex-row items-center flex-col gap-5">
        ...
        <div className="border-2 shadow-2xl md:w-[35%] shadow-blue-700 h-auto lg:w-[40%] lg:h-[80%] rounded-3xl w-[70%] backdrop-blur-sm flex   flex-col justify-center items-center lg:gap-5">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col h-auto w-full backdrop-blur-sm justify-center  items-center lg:gap-7">
            ...
            {/* Submit Button */}
            <button type="submit" className="bg-blue-300 h-7 w-20 shadow-2xl shadow-black mt-3 md:w-32 md:h-15 rounded-xl hover:scale-110 hover:rounded-md">
              Register
            </button>
          </form>
